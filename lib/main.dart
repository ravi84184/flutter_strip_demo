...
void main() async {
  ...
  Stripe.publishableKey = "pk_test_srIN1InLfZAWqe6L6nEn7w33005oASkg8F";
  Stripe.merchantIdentifier = 'merchant.com.caritasrevolution';
  runApp(const MyApp());
}
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const StripPaymentScreen(),
                  ),
                );
              },
